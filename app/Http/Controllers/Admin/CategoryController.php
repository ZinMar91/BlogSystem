...
class CategoryController extends Controller
{
    ...
    public function store(CategoryInsertFormRequest $request)
    {
        ...
        return redirect('admin/categories/create')->with('status', 'Category Created Successfully !');
    }
    ...
    public function update(CategoryInsertFormRequest $request, $id)
    {
        ...
        return redirect(action('admin\CategoryController@edit', $id))->with('status', 'Category Updated Successfully !');
    }
